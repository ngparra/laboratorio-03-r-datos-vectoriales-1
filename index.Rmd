...
5. (5%) Filtre el data frame ```world``` para extraer en otro data frame las observaciones correspondientes a los siete países de América Central. Mantenga las mismas columnas de los ejercicios anteriores y despliegue los datos en una tabla.
```{r}
# Se extraen las observaciones ordenadas por orden alfabético de país
