...
### Ejercicio 8 (25%)
Extraiga en un nuevo data frame los países de Centroamérica con esperanza de vida mayor o igual a 74 años y genere el mapa de coropletas y su título correspondientes.
```{r}
```