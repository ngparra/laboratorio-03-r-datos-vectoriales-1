...
ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Esperanza de vida para los países de Centroamérica, Belice y Panama") +
  xlab("Países") + 
  ylab("Esperanza de vida") +  
  geom_col() +
  geom_text(aes(label=lifeExp), vjust=-0.3, size=3.0)
```
...
```{r}
plot(centro_america["lifeExp"], main= "Mapa de Esperanza de vida para Centroamérica, Belice y Panama")
```
...
centro_america_expvida =world[(world$name_long == "Belize" |
                       ...
                       world$name_long == "Panama") 
                       & world$lifeExp >= 74 , ]
plot(centro_america_expvida["lifeExp"], main= "Mapa de Esperanza de vida mayor o igual a 74 años en Centroamérica, Belice y Panama")
```